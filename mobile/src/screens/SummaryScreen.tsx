...
const styles = StyleSheet.create({
  ...
  chip: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 20, borderWidth: 1, borderColor: colors.borderMedium, backgroundColor: colors.surface, gap: 8 },
  ...
  stageCard: { backgroundColor: colors.surface, borderRadius: 10, borderWidth: 1, borderColor: colors.borderLight, padding: 16, gap: 6 },
